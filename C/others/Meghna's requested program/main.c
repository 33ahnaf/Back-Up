...
int main()
{
    ...
    if (user_input_answer == 'D' || user_input_answer == 'd') score++;
    ...
    get_answer(&user_input_answer);
    if (user_input_answer == 'A' || user_input_answer == 'a') score++;

    print_question_with_options(3, "What does Meghna drink the most?", "Tea", "Beer", "Milk", "Green Tea");
    get_answer(&user_input_answer);
    if (user_input_answer == 'C' || user_input_answer == 'c') score++;
    ...
    get_answer(&user_input_answer);
    if (user_input_answer == 'B' || user_input_answer == 'b') score++;
