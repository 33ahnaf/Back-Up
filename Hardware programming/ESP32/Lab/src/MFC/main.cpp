...
#define PUMP_PIN 2 // ESP32 GPIO connected to your relay module
...
void loop() {
  ...
  // Dynamic background data updating for Power App
  if (currentState == STATE_APP_POWER && millis() - lastDataUpdate > 800) {
    for (int i = 0; i < 4; i++) {
